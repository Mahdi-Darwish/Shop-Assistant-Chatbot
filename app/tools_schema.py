            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "quantity": {
                        "type": "integer",
                        "minimum": 1,
                        "description": "How many units to add. Must be at least 1. Defaults to 1.",
                    },
                },
...
# Guest (not-logged-in) visitors can browse the menu but can't touch a
# cart, an order, or an account — so they only ever get these four
# read-only tools passed to the model, never the full `tools` list above.
guest_tools = [
    {
        "type": "function",
        "function": {
